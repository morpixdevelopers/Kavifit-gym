...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="pt-16">
        <Hero
          onJoinClick={() => setDemoModalOpen(true)}
          onResultsClick={() => {}}
        />
        <WhyChooseUs />
        ...
        <section id="contact-us" className="py-12 px-6 bg-gradient-to-b from-slate-900 to-slate-800">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border-2 border-orange-500/20">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-xl md:text-2xl font-black text-white">OPENING HOURS</h2>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-1.5 border-b border-gray-700">
                      ...
                      <span className="text-sm text-orange-400 font-semibold">6:00 AM - 11:00 PM</span>
                    </div>
                    <div className="flex justify-between items-center py-1.5 border-b border-gray-700">
                      <span className="text-sm font-bold text-white">Saturday</span>
                      <span className="text-sm text-orange-400 font-semibold">7:00 AM - 10:00 PM</span>
                    </div>
                    <div className="mt-4 p-3 bg-gradient-to-r from-orange-500/10 to-red-600/10 rounded-lg border border-orange-500/30">
                      <p className="text-center text-white font-bold text-sm">24/7 Access Available</p>
                      <p className="text-center text-gray-400 text-xs mt-1">For Premium Members</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border-2 border-orange-500/20">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-xl md:text-2xl font-black text-white">LOCATION</h2>
                  </div>
                  <div className="space-y-2 text-gray-300">
                    <p className="text-base font-bold text-white">IRON FITNESS</p>
                    ...
                    <p className="text-sm">Email: info@ironfitness.com</p>
                  </div>
                </div>
              </div>
      ...
      <footer className="py-4 px-6 bg-slate-900 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400 text-sm">
            Developed by <span className="text-orange-500 font-bold">morpix</span>
          </p>
        </div>
      </footer>
